...
public class OS extends MoiseElement implements ToXML {
    ...
    public Element getAsDOM(Document document) {
        ...
        ele.setAttribute("xmlns","https://moise-exceptions.sourceforge.io/os");
        ele.setAttribute("xmlns:xsi","http://www.w3.org/2001/XMLSchema-instance");
        ele.setAttribute("xsi:schemaLocation","https://moise-exceptions.sourceforge.io/os https://moise-exceptions.sourceforge.io/xml/0.3/os.xsd");
