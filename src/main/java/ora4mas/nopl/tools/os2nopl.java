...
public class os2nopl {
	...
	static {
		...
		condCode.put(PROP_ExcAgNotAllowed,
				"thrown(S,E,Ag) & exception(E,_) & mission_exception(M,E) & not committed(Ag,M,S)");
		condCode.put(PROP_ExcCondNotHolding,
				"thrown(S,E,Ag) & exception(E,Condition) & mission_exception(M,E) & committed(Ag,M,S) & not Condition");
